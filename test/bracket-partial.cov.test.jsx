...
const SOUTH_R64 = [
  ...
  game({ id: 's64-0', round: 'R64', region: 'South', home: 'A1', away: 'A16', homeSeed: 1, awaySeed: 16, score: [80, 60], live: true }),
  game({ id: 's64-1', round: 'R64', region: 'South', home: 'A8', away: 'A9', homeSeed: 8, awaySeed: 9, score: [70, 60], winner: 'home' }),
  game({ id: 's64-2', round: 'R64', region: 'South', home: 'A5', away: 'A12', homeSeed: 5, awaySeed: 12, score: [70, 68], winner: 'home' }),
  // slot3 still LIVE (no winner) — its R32 parent's second feeder is thus unknown.
  game({ id: 's64-3', round: 'R64', region: 'South', home: 'A4', away: 'A13', homeSeed: 4, awaySeed: 13, score: [77, 50], live: true }),
  game({ id: 's64-4', round: 'R64', region: 'South', home: 'A6', away: 'A11', homeSeed: 6, awaySeed: 11, score: [70, 66], winner: 'home' }),
  game({ id: 's64-5', round: 'R64', region: 'South', home: 'A3', away: 'A14', homeSeed: 3, awaySeed: 14, score: [88, 60], winner: 'home' }),
  game({ id: 's64-6', round: 'R64', region: 'South', home: 'A7', away: 'A10', homeSeed: 7, awaySeed: 10, score: [72, 70], winner: 'home' }),
  game({ id: 's64-7', round: 'R64', region: 'South', home: 'A2', away: 'A15', homeSeed: 2, awaySeed: 15, score: [90, 55], winner: 'home' }),
]
const SOUTH_R32 = [
  // (slot0 live, slot1 A8): only the SECOND feeder is known -> joins()'s `if (wB)` branch.
  game({ id: 's32-0', round: 'R32', region: 'South', home: 'A8', away: 'A1', homeSeed: 8, awaySeed: 1, score: [75, 70], winner: 'home' }),
  // (slot2 A5, slot3 live): only the FIRST feeder is known -> joins()'s `if (wA)` branch.
  game({ id: 's32-1', round: 'R32', region: 'South', home: 'A5', away: 'A4', homeSeed: 5, awaySeed: 4, score: [80, 78], winner: 'home' }),
  game({ id: 's32-2', round: 'R32', region: 'South', home: 'A6', away: 'A3', homeSeed: 6, awaySeed: 3, score: [82, 79], winner: 'home' }),
  game({ id: 's32-3', round: 'R32', region: 'South', home: 'A7', away: 'A2', homeSeed: 7, awaySeed: 2, score: [85, 80], winner: 'home' }),
]
const SOUTH_S16 = [
  game({ id: 's16-0', round: 'S16', region: 'South', home: 'A8', away: 'A5', homeSeed: 8, awaySeed: 5, score: [70, 68], winner: 'home' }),
  game({ id: 's16-1', round: 'S16', region: 'South', home: 'A6', away: 'A7', homeSeed: 6, awaySeed: 7, score: [75, 74], winner: 'home' }),
]
const SOUTH_E8 = game({ id: 's8-0', round: 'E8', region: 'South', home: 'A8', away: 'A6', homeSeed: 8, awaySeed: 6, score: [72, 70], winner: 'home' })

// East: an orphan R32 game with NO seeds and no parent R64 -> leftover fill + the
// `seed ?? 99` sort fallback in slotFromGame.
const EAST_ORPHAN = game({ id: 'e32-0', round: 'R32', region: 'East', home: 'E1', away: 'E2', score: [60, 50], winner: 'home' })
...
describe('buildBracket — a partial tournament', () => {
  ...
  it('lineage-fills an orphaned East game that has no parent Round-of-64', () => {
    const east = b.regions.find((r) => r.name === 'East')
...
describe('buildBracket — games that do not fit the lineage', () => {
  ...
  const LINEAGE = game({
    id: 'm32-0', round: 'R32', region: 'Midwest',
  ...
  const ORPHAN = game({
    id: 'm32-x', round: 'R32', region: 'Midwest',
...
describe('Bracket component — partial field render', () => {
  ...
  it('renders completed, live, and projected matches across region tabs', () => {
    ...
    fireEvent.click(screen.getByRole('tab', { name: 'South' }))
    ...
    fireEvent.click(screen.getByRole('tab', { name: 'East' }))
