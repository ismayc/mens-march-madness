...
[![CI](https://github.com/ismayc/mens-march-madness/actions/workflows/ci.yml/badge.svg)](https://github.com/ismayc/mens-march-madness/actions/workflows/ci.yml)
[![coverage](https://img.shields.io/endpoint?url=https://ismayc.github.io/mens-march-madness/coverage.json)](https://github.com/ismayc/mens-march-madness/actions/workflows/ci.yml)

An unofficial, timezone-aware viewer for the **NCAA Division I Men's Basketball
Tournament** — the full 68-team bracket, every game in your timezone, live scores, and the
road to the Final Four.

🔗 **Live:** [ismayc.github.io/mens-march-madness](https://ismayc.github.io/mens-march-madness/) ·
[mens-march-madness.netlify.app](https://mens-march-madness.netlify.app)
...
- **The bracket** — four regional sub-brackets (South · East · Midwest · West), each seeded
...
(`/mens-march-madness/`) and the Netlify root with no separate build.
...
results, and game data via [ESPN](https://www.espn.com/mens-college-basketball/). Created by
