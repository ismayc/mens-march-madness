...
const NS = 'mmm' // localStorage namespace — men's March Madness
  ...
  return (
    <div className="app">
      <header className="top">
        <div className="brand">
          <h1>
            Men's March Madness <span className="season">{SEASON}</span>
          </h1>
          <p className="tagline">
            The NCAA Division I men's tournament bracket, in your timezone
            {nLive > 0 && (
      ...
      <footer className="foot">
        ...
        <div className="foot-row">
          <p className="credit">
            ...
            ·{' '}
            <a
              href="https://github.com/ismayc/mens-march-madness"
              target="_blank"
              rel="noopener noreferrer"
            >
