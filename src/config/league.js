...
export const LEAGUE = {
  ...
  title: "Men's March Madness",
  tagline: 'the NCAA tournament bracket in your timezone',
  season: SEASON,
  espnPath: 'basketball/mens-college-basketball',
  storageKey: 'mmm', // 'mmm:theme', 'mmm:followed', 'mmm:alerts', …
  // UI chrome only. Matches --bg in index.css, <meta name="theme-color">, and the
  // manifest's theme_color and background_color.
  themeColor: '#15171b',

  // ── Vocabulary ──────────────────────────────────────────────────────────────
  // The men's college game is two HALVES. The women's tournament is four quarters,
  // which is the single most load-bearing difference between these two repos and the
  // one their shared code keeps getting wrong: a 4 copied in from the women's viewer
  // is what stopped nailbiter alerts firing before 2OT, and is why the linescore
  // heading read "By quarter" here.
  periodNoun: 'half',
  regulationPeriods: 2,
  periodLabels: ['1ST', '2ND'],
  overtimeLabel: 'OT',
  homeAwaySep: 'vs',
  tipoffLabel: 'Tipoff',
  ...
  ics: {
    durationIso: 'PT2H30M',
    prodId: '-//mens-march-madness//EN',
    domain: 'mens-march-madness',
    filenameBase: 'mens-march-madness',
  },

  // Netlify serves /calendar.ics; GitHub Pages cannot run the function.
  feedHost: 'https://mens-march-madness.netlify.app',
}
