...
const PROD = 'https://mens-march-madness.netlify.app'
        ...
        <div className="cal-section">
          ...
          <div className="cal-downloads">
            <button
              onClick={() =>
                downloadIcs(games, {
                  filename: `mens-march-madness-${SEASON}.ics`,
                  name: `Men's March Madness ${SEASON}`,
                })
              }
            >
              ...
              <button
                onClick={() =>
                  downloadIcs(filtered, {
                    filename: `mens-march-madness-${SEASON}-filtered.ics`,
                    name: `Men's March Madness ${SEASON}`,
                  })
                }
              >
            ...
            {count > 0 && (
              <button
                onClick={() =>
                  downloadIcs(myGames, {
                    filename: `mens-march-madness-${SEASON}-my-teams.ics`,
                    name: `Men's March Madness ${SEASON} — My Teams`,
                  })
                }
              >
